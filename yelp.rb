...
#   response = HTTP.auth("Bearer ...").get(url, params: params)
#   response.parse
# end

# p search("vegan", "Chicago, IL")
...
# case command.first
# when "search"
#   dog = options.fetch(:term, DEFAULT_TERM)
...
#   p dog
#   response = search(dog, location).parse
